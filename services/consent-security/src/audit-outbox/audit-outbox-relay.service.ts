 ...
 * services/gp-authorisation/src/audit-outbox/audit-outbox-relay.service.ts
 * for the identical, more fully documented sibling. Every module in this
 * service (consent-records, reattestations, concerns, deceased) writes an
 * `AuditOutbox` row in the same DB transaction as its domain write; this
 * relay is the only thing that actually calls the Audit Log Service.
 */
@Injectable()

/**
 * REMOVED 2026-08-17 — this file used to declare a service-local `OnboardingAuditEventType`
 ...
 *
 * All 26 of these event types are now real members of the shared union and of
